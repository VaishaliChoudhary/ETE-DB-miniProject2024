...
class ResearchProject(models.Model):
    ...
    co_pi_name = models.CharField(max_length=255, blank=True, null=True)
...
class AcceptedProject(models.Model):
    research_project = models.OneToOneField(ResearchProject, on_delete=models.CASCADE)

    def __str__(self):
        return self.research_project.project_name
...
class StudentResult(models.Model):
    GRADE_CHOICES = [('O', 'O'), ('A+','A+'),('A', 'A'), ('B+','B+'),('B', 'B'), ('C+','C+'),('C', 'C'), ('F', 'F'), ('P', 'P'), ('NE', 'NE'),('X','X'),('I','I')]
